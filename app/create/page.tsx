...
export default function CreatePage() {
  ...
  async function checkAws(event: FormEvent<HTMLFormElement>) {
    ...
    setCheck({ kind: "checking", message: "Assuming IAM role and checking AWS resources..." });
    try {
      ...
      setCheck({ kind: "success", accountId: result.accountId, message: `AWS is ready. Account ${result.accountId} has a usable VPC, subnet, security group, and key pair.` });
